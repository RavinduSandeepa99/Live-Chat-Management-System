...
if(isset($_POST['username']) &&
   ...
   if (empty($name)) {
   	  ...
   	  # redirect to 'Instructor_signup.php' and passing error message
   	  header("Location: ../../Instructor_signup.php?error=$em");
   	  exit;
      ...
      # error message
   	  ...
   	  /*
    	redirect to 'Instructor_signup.php' and 
    	passing error message and data
      */
   	  header("Location: ../../Instructor_signup.php?error=$em&$data");
   	  exit;
      ...
      */
      ...
      if($stmt->rowCount() > 0){
      	...
      	# redirect to 'Instructor_index.php' and passing success message
      	header("Location: ../../Instructor_index.php?success=$sm");
     	exit;
      }
