...
<head>
	...
	<title>LiveChat - Instructor Home</title>
    ...
    <div class="p-2 w-400
    	...
    	<div>
    		<div class="d-flex
              ...
              <a href="app/ajax/delete.php?user_id=<?php echo $user["user_id"]; ?>"
            class="btn btn-danger m-1">Delete</a>
    			<a href="Instructor_logout.php"
    		...
    		<ul id="chatList"
    			...
    			<?php if (!empty($conversations)) { ?>
	    			...
	    			<li class="list-group-item">
	    				<a href="Instructor_chat.php?user=<?=$conversation['username']?>"
	    				   class="d-flex
	    				          justify-content-between
    			...
    			<?php }else{ ?>
    				<div class="alert alert-info 
                     ...
                     No messages yet, Start the conversation,Search student
